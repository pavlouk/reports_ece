...
INSERT_VALIDATION = "INSERT OR IGNORE INTO Validation (card_id, itinerary_id, embarkation_time) VALUES (?, ?, ?)"
...
INSERT_ARRIVAL = "INSERT INTO Arrives (itinerary_id, stop_id, real_toa) VALUES (?, ?, ?)"

INSERT_ITINERARY = "INSERT INTO Itinerary (starting_time, ending_time, direction, route_name, bus_id, driver_id) VALUES (?, ?, ?, ?, ?, ?)"
