...
dc_mask = np.zeros(dc_image.shape, dtype=np.uint8)
from skimage import draw 
rr, cc = draw.rectangle(start=(dc_image.shape[0]/2, dc_image.shape[1]/2), extent=(), shape=dc_image.shape)
dc_mask[rr, cc] = 1.0
new_image = dc_image * dc_mask 
...
""" from src.visualization import gif_maker 
    from gif_maker import cut_uncut_compare """

""" from src.features import downscale
    from downscale import downscale """

""" from src.visualization import gif_maker
    from gif_maker import snr_print """
