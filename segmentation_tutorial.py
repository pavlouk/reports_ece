# -*- coding: utf-8 -*-
"""
Created on Wed Oct 28 14:20:22 2020
...
img1 = Image.open(fp='C:/Users/plouk/Desktop/Project_ Cold exposure/Main Experiment/240h/Mouse1/BAT/IR_3855.jpg', mode='r')
img1 = np.array(img1)
mouseImg1 = img1[:, 111:255]
mouseImg1 = img_as_ubyte(rgb2gray(mouseImg1))
coins = mouseImg1
...
fig, axes = plt.subplots(1, 2, figsize=(8, 3), sharey=True)
axes[0].imshow(coins, cmap=plt.cm.coolwarm)
